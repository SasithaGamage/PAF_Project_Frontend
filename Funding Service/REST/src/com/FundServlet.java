...
//		doGet(request, response);
		String output = fundObj.insertItem(request.getParameter("researchID"), 
				request.getParameter("funderName"), 
				request.getParameter("amount"), 
				request.getParameter("fundingDate"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = fundObj.updateItem(paras.get("hidItemIDSave").toString(), 
		 ...
		 paras.get("fundingDate").toString(),
		 paras.get("fundStatus").toString()); 
		response.getWriter().write(output);
	}
